...
foreach ($edit_data as $row):
    ...
    <div id="payroll_print" class="container-fluid">
        <table width="100%" border="0">
            <tr>
                <td width="50%"><img src="http://localhost/bayanno/uploads/logo.png" style="max-height:80px;"></td>
                <td align="right">
        ...
        <h3 style="text-align: center; margin-bottom: 0px;"><?php echo get_phrase('payroll_summary'); ?></h3><br>
            ...
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
                        ...
                        <th width="60%"><?php echo get_phrase('allowance_summary'); ?></th>
        ...
        <?php } else { ?>
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
                        <th class="text-center">#</th>
                        <th width="60%"><?php echo get_phrase('deduction_summary'); ?></th>
                        <th><?php echo get_phrase('amount'); ?></th>
                    </tr>
                </thead>
...
<div>
    ...
    <a onClick="window.print('#payroll_print')" class="btn btn-primary hidden-print">
