...
<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_bed');?>');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('add_room'); ?>
</button>
            ...
            <tr>
                ...
                <td><?php echo $row['description'] ?></td>
                                <?php if ($row['status'] >= $row['bed_number']) { ?>
                                    <td><font color="red">Occupied</font></td>
                                <?php }else{ ?>
                                     <td><font color="green">vacant</font></td>
                                <?php } ?>                 
                ...
                <td>
                    ...
                    <a href="<?php echo site_url('nurse/bed/delete/'.$row['bed_id']); ?>"
